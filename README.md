...
The core logic lives in **[mfa_probe.py](https://github.com/uAckerman/Security-Control-Reliabilty-System/blob/main/IAM_mfa_probe.py)** and returns:
...
The core logic lives **[logging_probe.py](https://github.com/uAckerman/Security-Control-Reliabilty-System/blob/main/IAM_logging_probe.py)**
...
This file **[expected_controls.yaml](https://github.com/uAckerman/Security-Control-Reliabilty-System/blob/main/IAM_expected_controls.yaml)** expresses security expectations in a human-readable, version-controlled format.  
